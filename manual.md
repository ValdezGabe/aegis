...
## Phase 0 — Set up your workspace (½ day)
...
## Phase 3 — Build the inbound guard (2–3 days) ⭐
...
## Phase 4 — Build the outbound guard (1–2 days)
...
## Phase 5 — Harden the cloud setup (2–3 days) ⭐
...
- Learn just enough **KQL** (Kusto Query Language — Microsoft's log search language) to write 2–3 rules, such as:
...
## Phase 7 — Polish it into a portfolio piece (2–3 days)
...
- Record 2–3 minutes: send a normal request (works), send an attack (blocked), show the Sentinel alert firing.
...
| Week | Focus |
|------|-------|
| 1 | Phases 0–2: setup, basic gateway, connect the model |
| 2 | Phase 3: the inbound guard (the star) |
| 3 | Phases 4–5: outbound guard, secure cloud deployment |
| 4 | Phases 6–7: Sentinel logging, detection, and portfolio polish |

Part-time, this is comfortably a **4–6 week** project. That's fine — depth is what impresses, not speed.
